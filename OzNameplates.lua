...
function OzNameplates:UpdateFrame (nameplateFrame)
	...
	nameplateFrame.level:SetPoint("BOTTOMLEFT", nameplateFrame.healthBar, "TOPLEFT", 0, 2)
...
function OzNameplates:CreateFrame(frame)
	...
	newNameRegion:SetPoint("BOTTOM", healthBar, "TOP",  0, 0)
	...
	newNameRegion:SetWidth(frame.healthBar:GetWidth()-15)
	newNameRegion:SetWordWrap(false)
	frame.name = newNameRegion

	local percentageRegion = frame:CreateFontString()
	percentageRegion:SetPoint("LEFT", healthBar, "RIGHT", 2, 0)
